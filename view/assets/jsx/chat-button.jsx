            ...
            return (
                <div>
                    ...
                    <div className="message-panel">
                        <TextField hintText="Message" ref={component => this._textInput = component} onChange={this._handleInputChange}/>
                        <RaisedButton label="Send" disabled={this.state.disButtonState} secondary={true} onClick={this.sendToChat}/>
                    </div>
